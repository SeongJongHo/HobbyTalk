...
import com.jongho.openChat.application.facade.WebSocketOpenChatRoomFacadeImpl;
...
public class WebSocketOpenChatRoomHandler extends TextWebSocketHandler {
    ...
    private final WebSocketOpenChatRoomFacadeImpl webSocketOpenChatRoomFacade;
